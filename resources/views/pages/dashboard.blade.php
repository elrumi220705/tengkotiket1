                    ...
                    @foreach ($sideImages as $img)
                        @if (!empty($img))
                            <div class="small-image">
                                <img src="{{ asset('storage/' . $img) }}" alt="Side image">
                            </div>
                        @endif
                    @endforeach
                </div>
            ...
            <div class="details-grid">
                ...
                <div class="festival-info">
                    ...
                    <div class="info-section">
                        ...
                        <div class="event-description clean-box">
                ...
                <div class="festival-sidebar">
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="location-map">
                            <iframe src="https://www.google.com/maps?q={{ urlencode($mainEvent->lokasi) }}&output=embed"
