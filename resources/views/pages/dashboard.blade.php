            ...
            <div class="container">
                <div class="gallery-grid">
                    ...
                    <div class="main-image">
                        <img src="{{ asset('storage/' . ($mainEvent->gambar ?? 'default.jpg')) }}"
                            alt="{{ $mainEvent->nama_event }}">
                    </div>

                    <!-- Side Images -->
                    <div class="side-images">
                        @php
                            $sideImages = $similarEvents->take(4)->pluck('gambar');
                        @endphp

                        {{-- Looping melalui gambar-gambar utama dari event-event serupa --}}
                        @foreach ($sideImages as $img)
                            @if (!empty($img))
                                <div class="small-image">
                                    {{-- Gunakan path gambar yang sudah benar dari database --}}
                                    <img src="{{ asset('storage/' . $img) }}" alt="{{ $mainEvent->nama_event }} side view">
                                </div>
                            @endif
                        @endforeach
                    </div>
                            ...
                            <div class="info-grid">
                                <div class="info-item">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <div class="info-time">
                                            {{ $mainEvent->tanggal_mulai->format('H:i') }} -
                                            {{ $mainEvent->tanggal_selesai->format('H:i') }}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ticket-options">
                                <div class="ticket-option selected">
                                    ...
                                    <div class="ticket-price">
                                        <span class="price">Rp
                                            {{ number_format($mainEvent->harga_dasar, 0, ',', '.') }}</span>
                            ...
                            <div class="event-card">
                                <div class="event-card-header">
                                    ...
                                    <div class="event-image">
                                        <img src="{{ asset('storage/' . ($event->gambar ?? 'default.jpg')) }}"
